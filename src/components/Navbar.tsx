...
export function Navbar() {
  ...
  return (
    <>
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-40 bg-black/60 backdrop-blur-2xl transition-all duration-500 md:hidden flex flex-col items-center justify-center gap-8 ${
          menuOpen
      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        <nav className="flex items-center justify-between px-6 md:px-10 py-4 mx-4 mt-3 rounded-full bg-black/40 backdrop-blur-xl md:mx-6">
          {/* Logo */}
          <TransitionLink
            href="/"
